function updateSignups() {
    ...
    if(timenow.format("E") >= 2 && timenow.format("E") <= 5) {
        var matchlink = "https://smash.gg/tournament/rg-3v3-weekly-" + (parseInt(timenow.format("WW")) + 44).toString() + "-eu-pc-ps4/register/embed";
        $("#weeklylink").html("<p>This week's tournament page can be found <a href='https://smash.gg/RGw" + (parseInt(timenow.format("WW")) + 44).toString() + "'>here</a> if you need it.")
    }
    else {
